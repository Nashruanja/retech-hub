...
<head>
    ...
    * {
    ...
    .input-wrap input:focus {
        border-color: #4D7C5F;
        box-shadow: 0 0 0 3px rgba(77, 124, 95, .1);
        background: #fff;
    }
    ...
    .btn-submit:hover {
        background: linear-gradient(135deg, #4D7C5F, #2D5016);
        transform: translateY(-1px);
        box-shadow: 0 6px 20px rgba(77, 124, 95, .3);
    }
...
<body>
    ...
    <div class="left-panel">
        ...
        <div class="alert-err" style="background:#ECFDF5;border-color:#A7F3D0;color:#065F46;"><i
                class="bi bi-check-circle"></i><?= e($flash['msg']) ?></div>
        <?php endif; ?>
        ...
        <form method="POST">
            ...
            <div class="mb-3">
                ...
                <div class="input-wrap">
                    ...
                    <input type="email" name="email" placeholder="nama@email.com" value="<?= e(post('email')) ?>"
                        required>
                </div>
            </div>
    ...
    <div class="right-panel">
        <div class="right-content">
            ...
            <p>Platform servis elektronik berbasis circular economy. Diagnosa AI, teknisi terpercaya, dan pengelolaan
                e-waste bertanggung jawab.</p>

            <div class="feat-pill">
                <div class="icon" style="background:rgba(111,207,158,.25);">🤖</div>
                <div><strong style="display:block;font-size:.83rem;">Diagnosa AI</strong><span
                        style="font-size:.75rem;opacity:.65;">Powered by Google Gemini</span></div>
            </div>
            <div class="feat-pill">
                <div class="icon" style="background:rgba(52,211,153,.2);">⭐</div>
                <div><strong style="display:block;font-size:.83rem;">Teknisi Terrating</strong><span
                        style="font-size:.75rem;opacity:.65;">Filter by rating, tercepat, terlaris</span></div>
            </div>
            <div class="feat-pill">
                <div class="icon" style="background:rgba(251,191,36,.2);">🛡️</div>
                <div><strong style="display:block;font-size:.83rem;">Garansi Servis</strong><span
                        style="font-size:.75rem;opacity:.65;">Klaim garansi langsung via WhatsApp</span></div>
            </div>
            <div class="feat-pill">
                <div class="icon" style="background:rgba(248,113,113,.2);">♻️</div>
                <div><strong style="display:block;font-size:.83rem;">E-Waste Management</strong><span
                        style="font-size:.75rem;opacity:.65;">Drop-off atau chat WA lokasi terdekat</span></div>
            </div>
        </div>
    </div>
